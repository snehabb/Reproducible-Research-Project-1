...
**Step 1
Code for getting sense of the dataset and/or processing the data**
```{r, echo = TRUE}
setwd("C:/Users/user/Documents/R/Coursera/Reproducible-Research-Project-1")
...
**Step 3
Mean and median number of steps taken every day**
...
I will use the mean/mode value substitution strategy to impute missing values. That is, using the mean values to substitute out the missing values in the original data set
